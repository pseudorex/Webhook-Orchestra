...
def run_test():
    ...
    WEBHOOK_DELIVERY_ATTEMPTS_TOTAL.labels(tenant_id="12", status_code="200", error_class="None").inc()
    WEBHOOK_DELIVERY_LATENCIES_SECONDS.labels(tenant_id="12").observe(0.125)
    ...
    # Assertions
    assert "webhook_delivery_attempts_total{error_class=\"None\",status_code=\"200\",tenant_id=\"12\"} 1.0" in output
    assert "webhook_delivery_latencies_seconds_bucket{le=\"0.25\",tenant_id=\"12\"} 1.0" in output
